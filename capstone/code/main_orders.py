...
# Split train_dataset into train_dataset and test_dataset 80-20
sss = StratifiedShuffleSplit(n_splits=1,  test_size=0.20, random_state=np.random.seed(19))
...
# Split remailin test_dataset into test_dataset and validation_dataset 10 -10 : trainin data must me as high as possible!
